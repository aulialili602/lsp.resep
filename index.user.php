  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="login-admin.php" class="d-block">Dashboard</a>
        </div>
      </div>
        ...
        <!-- <?php foreach ($resep as $resep) : ?>  -->
          <!-- <div class="col-lg-3 col-6"> -->
            ...
            <div class="small-box" style="background-color:	#99090c;">
              ...
              <div class="fs-2"><strong><?php echo $resep['nama']; ?></strong></div>
            </div>
            <div class="text-center mb-3">
            <button type="button" class="btn btn-outline-secondary rounded-pill"><a href="index.awal.php?id=<?= $resep['id_resep'] ?>" style="text-decoration: none; color: white;">More Info</a></button>
            </div>
          </div>
          <?php endforeach; ?>
